(() => {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    if (brand && !brand.querySelector("[data-locale-switch]")) {
    ...
    set(".inspector .section:nth-of-type(1) h3", "可比排名"); set(".rank-note", "只有共享同一评测协议的记录才会一起排名。"); set('label[for="comparisonSelect"]', "评测协议分组");
    set(".inspector .section:nth-of-type(2) h3", "运行配置说明"); set('label[for="variantSelect"]', "报分来源");
    ...
    set(".brand .subtitle", "探索 AI Benchmark 全景"); set("#modelViewTab", "模型"); set("#overallViewTab", "整体排名");
