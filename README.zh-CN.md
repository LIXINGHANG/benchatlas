...
- 查看“**公开榜单平均百分位**”，汇总基础模型在有效公开可比组中的归一化名次。
...
整体排名汇总模型在**有效公开榜单中的平均归一化名次**，不代表默认产品体验、API 延迟、调用成本或绝对智能水平。

1. 每个至少包含 3 个基础模型和 2 个厂商的可比组都会参与计算。
...
5. family 覆盖较少的模型向 50 收缩；family 数、领域覆盖和独立报告数共同决定置信度。
